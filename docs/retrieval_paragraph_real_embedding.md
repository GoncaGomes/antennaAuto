# Retrieval Benchmark: paragraph_real_embedding
...
- `chunk:chunk_026` page=4 score=0.826816
  ...
  - diagnostics: bm25_score=6.546159 dense_score=0.443031 bm25_rank=2 dense_rank=3 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.826816 rrf_score=None
- `section:page_004` page=4 score=0.777701
  - snippet: After choosing 28 GHz as the operating frequency, materials used for the antenna should be considered first. ... The most important criterion for determining the substrate in commercial applications is cost.
  - diagnostics: bm25_score=5.984653 dense_score=0.438195 bm25_rank=3 dense_rank=4 final_rank=3 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.777701 rrf_score=None
...
- `figure:fig_003` page=1 score=0.181083
...
Journal of Physics: Conference Series PAPER • OPEN ACCESS A microstrip patch antenna for 5G mobile communications To cite this article: Yitong Li 2023 J. Phys.: Conf. Ser. 2580 012063 View the article online for updates and enhancements. You ma
  - diagnostics: bm25_score=0.0 dense_score=0.254977 bm25_rank=None dense_rank=2 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.181083 rrf_score=None
- `figure:fig_002` page=1 score=0.181083
  - snippet: Caption extraction not implemented.
Journal of Physics: Conference Series PAPER • OPEN ACCESS A microstrip patch antenna for 5G mobile communications To cite this article: Yitong Li 2023 J. Phys.: Conf. Ser. 2580 012063 View the article online for updates and enhancements. You ma
  - diagnostics: bm25_score=0.0 dense_score=0.254977 bm25_rank=None dense_rank=3 final_rank=3 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.181083 rrf_score=None
...
- `chunk:chunk_010` page=4 score=0.887374
  - snippet: In the design, Rogers RT5880 substrate and copper ground are used.
  - diagnostics: bm25_score=5.778561 dense_score=0.383034 bm25_rank=2 dense_rank=1 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.887374 rrf_score=None
- `chunk:chunk_055` page=4 score=0.234976
...
**Figure 4.** VSWR of the proposed antenna on operating frequency
  - diagnostics: bm25_score=0.0 dense_score=0.300012 bm25_rank=None dense_rank=2 final_rank=3 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.234976 rrf_score=None
...
- `chunk:chunk_038` page=6 score=0.937453
  ...
  - diagnostics: bm25_score=7.298157 dense_score=0.449391 bm25_rank=1 dense_rank=2 final_rank=1 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.937453 rrf_score=None
- `chunk:chunk_045` page=7 score=0.767218
...
As using edge feed always brings large input impedance, altering the feeding position to the antenna’s center can be better for the current at both ends is generally low b
  - diagnostics: bm25_score=4.871189 dense_score=0.567764 bm25_rank=2 dense_rank=1 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.767218 rrf_score=None
- `chunk:chunk_023` page=7 score=0.592803
  ...
  - diagnostics: bm25_score=4.078349 dense_score=0.381595 bm25_rank=4 dense_rank=3 final_rank=3 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.592803 rrf_score=None
...
- `figure:fig_005` page=6 score=1.0
...
CONF-SPML-2023 Journal of Physics: Conference Series 2580 (2023) 012063 IOP Publishing doi:10.1088/1742-6596/2580/1/012063 5 From equations (7-8), it can be derived that the maximum value can be obtained when R equals r.
  - diagnostics: bm25_score=2.016284 dense_score=0.326505 bm25_rank=1 dense_rank=1 final_rank=1 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=1.0 rrf_score=None
- `figure:fig_003` page=1 score=0.163417
  - snippet: Caption extraction not implemented.
Journal of Physics: Conference Series PAPER • OPEN ACCESS A microstrip patch antenna for 5G mobile communications To cite this article: Yitong Li 2023 J. Phys.: Conf. Ser. 2580 012063 View the article online for updates and enhancements. You ma
  - diagnostics: bm25_score=0.0 dense_score=0.177855 bm25_rank=None dense_rank=2 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.163417 rrf_score=None
- `figure:fig_002` page=1 score=0.163417
  - snippet: Caption extraction not implemented.
Journal of Physics: Conference Series PAPER • OPEN ACCESS A microstrip patch antenna for 5G mobile communications To cite this article: Yitong Li 2023 J. Phys.: Conf. Ser. 2580 012063 View the article online for updates and enhancements. You ma
  - diagnostics: bm25_score=0.0 dense_score=0.177855 bm25_rank=None dense_rank=3 final_rank=3 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.163417 rrf_score=None
...
- `chunk:chunk_053` page=7 score=0.967265
  ...
  - diagnostics: bm25_score=4.224818 dense_score=0.354314 bm25_rank=2 dense_rank=2 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.967265 rrf_score=None
- `chunk:chunk_052` page=7 score=0.937508
  ...
  - diagnostics: bm25_score=4.266958 dense_score=0.306926 bm25_rank=1 dense_rank=3 final_rank=3 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.937508 rrf_score=None
...
- `figure:fig_006` page=7 score=1.0
  - snippet: The amount of reflection can be evaluated by the VSWR. ... At this time, VSWR will be the smallest, which is 1.
  - diagnostics: bm25_score=3.350087 dense_score=0.287877 bm25_rank=2 dense_rank=2 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=1.0 rrf_score=None
...
- `chunk:chunk_056` page=7 score=0.974546
  ...
  - diagnostics: bm25_score=5.492082 dense_score=0.501777 bm25_rank=2 dense_rank=2 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.974546 rrf_score=None
- `chunk:chunk_059` page=8 score=0.843498
  ...
  - diagnostics: bm25_score=4.665466 dense_score=0.453491 bm25_rank=4 dense_rank=3 final_rank=3 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.843498 rrf_score=None
...
- `figure:fig_005` page=6 score=0.493664
  ...
  - diagnostics: bm25_score=1.164532 dense_score=0.330165 bm25_rank=4 dense_rank=2 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.493664 rrf_score=None
...
CONF-SPML-2023 Journal of Physics: Conference Series 2580 (2023) 012063 IOP Publishing doi:10.1088/1742-6596/2580/1/012063 6 match the transmission line’s reference impedance at the operating frequency, which will gr
  - diagnostics: bm25_score=2.385604 dense_score=0.0 bm25_rank=2 dense_rank=None final_rank=3 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.475871 rrf_score=None
...
- `chunk:chunk_062` page=6 score=1.0
  ...
  - diagnostics: bm25_score=4.089534 dense_score=0.358343 bm25_rank=1 dense_rank=1 final_rank=1 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=1.0 rrf_score=None
- `chunk:chunk_063` page=8 score=0.984219
  ...
  - diagnostics: bm25_score=4.05913 dense_score=0.34571 bm25_rank=2 dense_rank=2 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.984219 rrf_score=None
- `chunk:chunk_065` page=9 score=0.774139
...
**Figure 6.** Gain vs. ... By doing this, the main lobe’s direction and its gain can be influenced, side lobes’ gain and direction can also be influenced.
  - diagnostics: bm25_score=3.547628 dense_score=0.199354 bm25_rank=3 dense_rank=4 final_rank=3 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.774139 rrf_score=None
...
- `figure:fig_010` page=9 score=1.0
  ...
  - diagnostics: bm25_score=3.468989 dense_score=0.227229 bm25_rank=1 dense_rank=1 final_rank=1 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=1.0 rrf_score=None
- `figure:fig_009` page=9 score=1.0
  - snippet: Gain vs. ... By doing this, the main lobe’s direction and its gain can be influenced, side lobes’ gain and direction can also be influenced.
  - diagnostics: bm25_score=3.468989 dense_score=0.227229 bm25_rank=2 dense_rank=2 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=1.0 rrf_score=None
...
- `chunk:chunk_053` page=7 score=0.931996
  - snippet: More specifically, for the reflection coefficient’s threshold of acceptance in the proposed antenna, its corresponding VSWR is 1.22. ... For the peak of the reflection coefficient, which is -24 dB, its corresponding VSWR is 1.008.
  - diagnostics: bm25_score=5.781236 dense_score=0.574153 bm25_rank=1 dense_rank=5 final_rank=1 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.931996 rrf_score=None
- `chunk:chunk_048` page=7 score=0.886648
  ...
  - diagnostics: bm25_score=5.300766 dense_score=0.605901 bm25_rank=4 dense_rank=2 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.886648 rrf_score=None
- `chunk:chunk_047` page=7 score=0.883035
  ...
  - diagnostics: bm25_score=5.632643 dense_score=0.49751 bm25_rank=2 dense_rank=6 final_rank=3 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.883035 rrf_score=None
...
- `figure:fig_007` page=7 score=1.0
  - snippet: Block diagram of S-parameter and S11 on the operating frequency
CONF-SPML-2023 Journal of Physics: Conference Series 2580 (2023) 012063 IOP Publishing doi:10.1088/1742-6596/2580/1/012063 6 match the transmission line’s reference impedance at the operating frequency, which will gr
  - diagnostics: bm25_score=4.577005 dense_score=0.623084 bm25_rank=1 dense_rank=1 final_rank=1 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=1.0 rrf_score=None
- `figure:fig_006` page=7 score=1.0
  - snippet: Block diagram of S-parameter and S11 on the operating frequency
CONF-SPML-2023 Journal of Physics: Conference Series 2580 (2023) 012063 IOP Publishing doi:10.1088/1742-6596/2580/1/012063 6 match the transmission line’s reference impedance at the operating frequency, which will gr
  - diagnostics: bm25_score=4.577005 dense_score=0.623084 bm25_rank=2 dense_rank=2 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=1.0 rrf_score=None
- `figure:fig_005` page=6 score=0.371219
  ...
  - diagnostics: bm25_score=1.133454 dense_score=0.410966 bm25_rank=3 dense_rank=3 final_rank=3 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.371219 rrf_score=None
...
- `chunk:chunk_047` page=7 score=0.833326
  ...
  - diagnostics: bm25_score=3.691879 dense_score=0.423641 bm25_rank=2 dense_rank=1 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.833326 rrf_score=None
- `chunk:chunk_021` page=1 score=0.808673
  ...
  - diagnostics: bm25_score=3.670616 dense_score=0.393166 bm25_rank=3 dense_rank=2 final_rank=3 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.808673 rrf_score=None
...
- `figure:fig_005` page=6 score=0.293471
...
CONF-SPML-2023 Journal of Physics: Conference Series 2580 (2023) 012063 IOP Publishing doi:10.1088/1742-6596/2580/1/012063 5 From equations (7-8), it can be derived that the maximum value can be obtained when R equals r. As the pho
  - diagnostics: bm25_score=0.0 dense_score=0.217644 bm25_rank=None dense_rank=2 final_rank=2 fusion_strategy=weighted chunking_mode=paragraph embedding_backend=sentence_transformer weighted_score=0.293471 rrf_score=None
