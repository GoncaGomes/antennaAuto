...
from ..llm.client import OpenAIAgentsStructuredClient, OpenAIJsonClient, StructuredGenerationResult
        ...
        try:
            ...
            if debug_dir is not None:
                write_json(
                    ...
                    {"raw_text": result.raw_text, "parsed": result.parsed.model_dump(exclude_none=True)},
                )
